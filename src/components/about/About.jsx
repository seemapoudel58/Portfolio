      ...
      <div className="flex flex-col items-center lg:flex-row lg:items-center lg:justify-around  ">
        <div className="mb-6 lg:mb-0 lg:mr-4">
          <img
            src={AboutImg}
            alt="about"
            className="w-56 h-56 lg:w-72 lg:h-72 rounded-full shadow-lg object-cover"
          />
        </div>
        ...
        <div className="flex flex-col items-center  ">
          ...
          <a
            download=""
            href={CV}
            className="inline-flex items-center text-white bg-indigo-500 px-4 py-2 rounded-lg hover:bg-indigo-600 "
          >
            Download CV
            <svg
